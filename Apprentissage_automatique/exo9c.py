...
forest=RandomForestClassifier(n_estimators=1000,class_weight='balanced_subsample',criterion='entropy',min_samples_split=20,max_features='sqrt',max_samples=0.4,)
forest.fit(x,y)
